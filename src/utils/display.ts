...
export function showUnusedFiles(categories: Record<string, string[]>) {
...
export function showSummary(totalFiles: number, unusedFiles: string[]) {
  ...
  console.log(
    chalk.blue(
      `| Total de Arquivos | Órfãos | % Código Utilizado | % Código Morto |`
    )
  );
  console.log(
    chalk.blue(
  ...
  console.log(
    chalk.green(
      `| ${totalFiles.toString().padEnd(16)} | ${unusedFiles.length
        .toString()
